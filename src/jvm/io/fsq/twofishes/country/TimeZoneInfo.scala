...
object TimeZoneInfo {
  ...
  private val tzLines =
    new BufferedSource(getClass.getResourceAsStream("/io/fsq/twofishes/country/data/timeZones.txt")).getLines.drop(1)
  private val timeZoneInfos: Seq[TimeZoneInfo] = tzLines
