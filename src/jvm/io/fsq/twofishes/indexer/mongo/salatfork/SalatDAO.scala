/*
 * NOTE(jacob): As of Feb 14, 2017 Salat does not have a release version that is compatible
 *    with 3.X versions of casbah and the mongo-java-driver. Thus we have this fork of
 *    SalatDAO in the meantime.
 *
 *
 *
 ...
 *
 */
package io.fsq.twofishes.indexer.mongo.salatfork
