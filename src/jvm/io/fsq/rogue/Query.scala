...
case class Query[M, R, +State](
  ...
  private def addClause[F](clause: M => QueryClause[F], expectedIndexBehavior: MaybeIndexed): Query[M, R, State] = {
  ...
  /**
    ...
    */
  def withShardKey[F, S2](
    clause: M => QueryClause[F] with ShardKeyClause
  ...
  private def addClauseOpt[V, F](
    opt: Option[V]
  )(clause: (M, V) => QueryClause[F], expectedIndexBehavior: MaybeIndexed) = {
    opt match {
  ...
  /**
    ...
    */
  def or[S2](
    subqueries: (Query[M, R, Ordered with Selected with Limited with Skipped with HasNoOrClause] => Query[M, R, _])*
  ...
  def select[F1, F2, S2](f1: M => SelectField[F1, M], f2: M => SelectField[F2, M])(
    implicit ev: AddSelect[State, S2, _]
  ): Query[M, (F1, F2), S2] = {
  ...
  def select[F1, F2, F3, F4, F5, F6, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
  ...
  def select[F1, F2, F3, F4, F5, F6, F7, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
  ...
  def select[F1, F2, F3, F4, F5, F6, F7, F8, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
  ...
  def select[F1, F2, F3, F4, F5, F6, F7, F8, F9, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
    ...
    selectCase(
      ...
      f8,
      f9,
      (f1: F1, f2: F2, f3: F3, f4: F4, f5: F5, f6: F6, f7: F7, f8: F8, f9: F9) => (f1, f2, f3, f4, f5, f6, f7, f8, f9)
    )
  }

  def select[F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
  ...
  def selectCase[F1, CC, S2](f1: M => SelectField[F1, M], create: F1 => CC)(
    implicit ev: AddSelect[State, _, S2]
  ): Query[M, CC, S2] = {
    val inst = meta
  ...
  def selectCase[F1, F2, CC, S2](f1: M => SelectField[F1, M], f2: M => SelectField[F2, M], create: (F1, F2) => CC)(
    implicit ev: AddSelect[State, S2, _]
  ): Query[M, CC, S2] = {
    val inst = meta
  ...
  def selectCase[F1, F2, F3, F4, CC, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
    ...
    val transformer = (xs: List[_]) =>
      create(xs(0).asInstanceOf[F1], xs(1).asInstanceOf[F2], xs(2).asInstanceOf[F3], xs(3).asInstanceOf[F4])
    this.copy(select = Some(MongoSelect(fields, transformer)))
  }

  def selectCase[F1, F2, F3, F4, F5, CC, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
  ...
  def selectCase[F1, F2, F3, F4, F5, F6, CC, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
  ...
  def selectCase[F1, F2, F3, F4, F5, F6, F7, CC, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
  ...
  def selectCase[F1, F2, F3, F4, F5, F6, F7, F8, CC, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
  ...
  def selectCase[F1, F2, F3, F4, F5, F6, F7, F8, F9, CC, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
  ...
  def selectCase[F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, CC, S2](
    f1: M => SelectField[F1, M],
    f2: M => SelectField[F2, M],
    f3: M => SelectField[F3, M],
    f4: M => SelectField[F4, M],
    ...
    val inst = meta
    val fields =
      List(f1(inst), f2(inst), f3(inst), f4(inst), f5(inst), f6(inst), f7(inst), f8(inst), f9(inst), f10(inst))
    val transformer = (xs: List[_]) =>
      create(
        xs(0).asInstanceOf[F1],
        xs(1).asInstanceOf[F2],
