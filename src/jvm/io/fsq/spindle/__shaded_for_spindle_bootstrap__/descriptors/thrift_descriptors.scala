...
import io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.java_thrift_descriptors.{JavaAnnotation,
    JavaAnnotationMeta, JavaAnnotationMutable, JavaAnnotationRaw, JavaBaseType, JavaBaseTypeMeta, JavaBaseTypeMutable,
    JavaBaseTypeRaw, JavaConst, JavaConstMeta, JavaConstMutable, JavaConstRaw, JavaContainerType,
    JavaContainerTypeMeta, JavaContainerTypeMutable, JavaContainerTypeRaw, JavaEnum, JavaEnumElement,
    JavaEnumElementMeta, JavaEnumElementMutable, JavaEnumElementRaw, JavaEnumMeta, JavaEnumMutable, JavaEnumRaw,
    JavaException, JavaExceptionMeta, JavaExceptionMutable, JavaExceptionRaw, JavaField, JavaFieldMeta,
    JavaFieldMutable, JavaFieldRaw, JavaFunction, JavaFunctionMeta, JavaFunctionMutable, JavaFunctionRaw, JavaInclude,
    JavaIncludeMeta, JavaIncludeMutable, JavaIncludeRaw, JavaListType, JavaListTypeMeta, JavaListTypeMutable,
    JavaListTypeRaw, JavaMapType, JavaMapTypeMeta, JavaMapTypeMutable, JavaMapTypeRaw, JavaNamespace,
    JavaNamespaceMeta, JavaNamespaceMutable, JavaNamespaceRaw, JavaProgram, JavaProgramMeta, JavaProgramMutable,
    JavaProgramRaw, JavaRequiredness, JavaService, JavaServiceMeta, JavaServiceMutable, JavaServiceRaw, JavaSetType,
    JavaSetTypeMeta, JavaSetTypeMutable, JavaSetTypeRaw, JavaSimpleBaseType, JavaSimpleContainerType,
    JavaSimpleContainerTypeMeta, JavaSimpleContainerTypeMutable, JavaSimpleContainerTypeRaw, JavaSimpleType,
    JavaSimpleTypeMeta, JavaSimpleTypeMutable, JavaSimpleTypeRaw, JavaStruct, JavaStructMeta, JavaStructMutable,
    JavaStructRaw, JavaType, JavaTypeMeta, JavaTypeMutable, JavaTypeRaw, JavaTypeRegistry, JavaTypeRegistryMeta,
    JavaTypeRegistryMutable, JavaTypeRegistryRaw, JavaTypedef, JavaTypedefMeta, JavaTypedefMutable, JavaTypedefRaw,
    JavaTyperef, JavaTyperefMeta, JavaTyperefMutable, JavaTyperefRaw, JavaUnion, JavaUnionMeta, JavaUnionMutable,
    JavaUnionRaw}
...
) extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.Enum[SimpleBaseType] with JavaSimpleBaseType with org.apache.thrift.TEnum {
...
sealed abstract class Requiredness private (
    ...
    override val name: String,
    override val stringValue: String
) extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.Enum[Requiredness] with JavaRequiredness with org.apache.thrift.TEnum {
  override def toString: String = stringValue
  override def getValue: Int = id
...
class IncludeMeta
  ...
  override def createUntypedRawRecord: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedRecord = createRawRecord
  override def createRecord: Include = createRawRecord
  override def createRawRecord: RawInclude = new RawInclude

  override def untypedIfInstanceFrom(x: AnyRef): Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedRecord] = ifInstanceFrom(x)
  ...
  val path =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Include, IncludeMeta](
      ...
      owner = this,
      getter = _.pathOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Include], v: String) => { r.asInstanceOf[RawInclude].path_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Include]) => { r.asInstanceOf[RawInclude].pathUnset() },
      manifest = manifest[String]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Include, IncludeMeta]] =
...
class IncludeCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Include] {
...
final class RawInclude extends JavaIncludeRaw[
  ...
  override def read(iprot: org.apache.thrift.protocol.TProtocol) {
    ...
    def currentUnknownFields(): io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UnknownFields = currentUnknownFieldsOpt match {
      case Some(uf) => uf
      case None => {
...
class NamespaceMeta
  ...
  val language =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Namespace, NamespaceMeta](
      name = "language",
      longName = "language",
      id = 1,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Namespace], v: String) => { r.asInstanceOf[RawNamespace].language_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Namespace]) => { r.asInstanceOf[RawNamespace].languageUnset() },
      manifest = manifest[String]
    )
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Namespace, NamespaceMeta](
      ...
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Namespace], v: String) => { r.asInstanceOf[RawNamespace].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Namespace]) => { r.asInstanceOf[RawNamespace].nameUnset() },
      manifest = manifest[String]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Namespace, NamespaceMeta]] =
...
class NamespaceCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Namespace] {
...
class AnnotationMeta
  ...
  val key =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Annotation, AnnotationMeta](
      name = "key",
      longName = "key",
      id = 1,
      annotations = Map(),
      owner = this,
      getter = _.keyOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Annotation], v: String) => { r.asInstanceOf[RawAnnotation].key_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Annotation]) => { r.asInstanceOf[RawAnnotation].keyUnset() },
      manifest = manifest[String]
    )
  ...
  val value =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Annotation, AnnotationMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Annotation], v: String) => { r.asInstanceOf[RawAnnotation].value_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Annotation]) => { r.asInstanceOf[RawAnnotation].valueUnset() },
      manifest = manifest[String]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Annotation, AnnotationMeta]] =
...
class AnnotationCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Annotation] {
...
object BaseType extends BaseTypeMeta {
  ...
  class Builder[+State] private[BaseType] (private var obj: RawBaseType) {
    def simpleBaseType(v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType): BaseType.Builder[State with Builder.HasSimpleBaseType] = {
      obj.simpleBaseType_=(v)
      this.asInstanceOf[BaseType.Builder[State with Builder.HasSimpleBaseType]]
    }


    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): BaseType.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): BaseType.Builder[State] = {
      vOpt match {
...
class BaseTypeMeta
  ...
  val simpleBaseType =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType, BaseType, BaseTypeMeta](
      name = "simpleBaseType",
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[BaseType], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType) => { r.asInstanceOf[RawBaseType].simpleBaseType_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[BaseType]) => { r.asInstanceOf[RawBaseType].simpleBaseTypeUnset() },
      manifest = manifest[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], BaseType, BaseTypeMeta](
      name = "annotations",
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[BaseType], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawBaseType].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[BaseType]) => { r.asInstanceOf[RawBaseType].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, BaseType, BaseTypeMeta]] =
...
class BaseTypeCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[BaseType] {
...
trait BaseType
    extends JavaBaseType[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
  ...
  def copy(
      ...
      __annotations: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = annotationsOrNull
  ): BaseType
...
trait MutableBaseType extends BaseType
    with JavaBaseTypeMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
      BaseType, RawBaseType, BaseTypeMeta
    ] {
  ...
  def __annotations_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Unit
...
final class RawBaseType extends JavaBaseTypeRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
      BaseType, RawBaseType, BaseTypeMeta
    ]
  ...
  private var _simpleBaseType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType
  override def simpleBaseType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType = simpleBaseTypeOrThrow
  override def simpleBaseType_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType): Unit = { _simpleBaseType = x }
  override def simpleBaseTypeOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType] = if (simpleBaseTypeIsSet) Some(_simpleBaseType) else None
  override def simpleBaseTypeOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType = _simpleBaseType
  override def simpleBaseTypeOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType = if (simpleBaseTypeIsSet) _simpleBaseType else throw new java.lang.NullPointerException("field simpleBaseType of BaseType missing")
  ...
  private var _annotations: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]
  override def __annotations: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = annotationsOrDefault
  override def __annotations_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Unit = { _annotations = x }
  override def annotationsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]] = if (annotationsIsSet) Some(_annotations) else None
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of BaseType missing")
        ...
        field_header.id match {
          case 1 => {  // simpleBaseType
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.I32 || field_header.`type` == org.apache.thrift.protocol.TType.ENUM) {
              _simpleBaseType = io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType.findByIdOrUnknown(iprot.readI32())
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field_header.`type`)
            }
          }
          case 99 => {  // annotations
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _annotations = {
                ...
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]
  ...
  def setFieldValue(field: BaseType._Fields, value: AnyRef) {
    field match {
      case BaseType._Fields.simpleBaseType => simpleBaseType_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleBaseType])
      case BaseType._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
class ListTypeMeta
  ...
  val elementTypeId =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, ListType, ListTypeMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[ListType], v: String) => { r.asInstanceOf[RawListType].elementTypeId_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[ListType]) => { r.asInstanceOf[RawListType].elementTypeIdUnset() },
      manifest = manifest[String]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, ListType, ListTypeMeta]] =
...
class ListTypeCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[ListType] {
...
class SetTypeMeta
  ...
  val elementTypeId =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, SetType, SetTypeMeta](
      ...
      owner = this,
      getter = _.elementTypeIdOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SetType], v: String) => { r.asInstanceOf[RawSetType].elementTypeId_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SetType]) => { r.asInstanceOf[RawSetType].elementTypeIdUnset() },
      manifest = manifest[String]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, SetType, SetTypeMeta]] =
...
class SetTypeCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[SetType] {
...
class MapTypeMeta
  ...
  val keyTypeId =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, MapType, MapTypeMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[MapType], v: String) => { r.asInstanceOf[RawMapType].keyTypeId_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[MapType]) => { r.asInstanceOf[RawMapType].keyTypeIdUnset() },
      manifest = manifest[String]
    )
  ...
  val valueTypeId =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, MapType, MapTypeMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[MapType], v: String) => { r.asInstanceOf[RawMapType].valueTypeId_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[MapType]) => { r.asInstanceOf[RawMapType].valueTypeIdUnset() },
      manifest = manifest[String]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, MapType, MapTypeMeta]] =
...
class MapTypeCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[MapType] {
...
object ContainerType extends ContainerTypeMeta {
  ...
  class Builder[+State] private[ContainerType] (private var obj: RawContainerType) {
    def simpleContainerType(v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType): ContainerType.Builder[State with Builder.HasSimpleContainerType] = {
      obj.simpleContainerType_=(v)
      this.asInstanceOf[ContainerType.Builder[State with Builder.HasSimpleContainerType]]
    }


    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): ContainerType.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): ContainerType.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class ContainerTypeMeta
  ...
  val simpleContainerType =
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.StructFieldDescriptor[ContainerType, ContainerTypeMeta, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerTypeMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[ContainerType], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType) => { r.asInstanceOf[RawContainerType].simpleContainerType_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[ContainerType]) => { r.asInstanceOf[RawContainerType].simpleContainerTypeUnset() },
  ...
  val __annotations =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], ContainerType, ContainerTypeMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[ContainerType], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawContainerType].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[ContainerType]) => { r.asInstanceOf[RawContainerType].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, ContainerType, ContainerTypeMeta]] =
    Vector[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, ContainerType, ContainerTypeMeta]](
      simpleContainerType,
      __annotations
    )
...
class ContainerTypeCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[ContainerType] {
...
trait ContainerType
    extends JavaContainerType[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType,
  ...
  def copy(
      simpleContainerType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType = simpleContainerTypeOrNull,
      __annotations: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = annotationsOrNull
  ): ContainerType
...
trait MutableContainerType extends ContainerType
    with JavaContainerTypeMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType,
      ContainerType, RawContainerType, ContainerTypeMeta
    ] {
...
final class RawContainerType extends JavaContainerTypeRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType,
      ContainerType, RawContainerType, ContainerTypeMeta
    ]
  ...
  private var _simpleContainerType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType
  override def simpleContainerType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType = simpleContainerTypeOrThrow
  override def simpleContainerType_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType): Unit = { _simpleContainerType = x }
  override def simpleContainerTypeOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType] = if (simpleContainerTypeIsSet) Some(_simpleContainerType) else None
  override def simpleContainerTypeOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType = _simpleContainerType
  override def simpleContainerTypeOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType = if (simpleContainerTypeIsSet) _simpleContainerType else throw new java.lang.NullPointerException("field simpleContainerType of ContainerType missing")
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of ContainerType missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
  ...
  def setFieldValue(field: ContainerType._Fields, value: AnyRef) {
    field match {
      case ContainerType._Fields.simpleContainerType => simpleContainerType_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleContainerType])
      case ContainerType._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
class TyperefMeta
  ...
  val typeAlias =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Typeref, TyperefMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Typeref], v: String) => { r.asInstanceOf[RawTyperef].typeAlias_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Typeref]) => { r.asInstanceOf[RawTyperef].typeAliasUnset() },
      manifest = manifest[String]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Typeref, TyperefMeta]] =
...
class TyperefCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Typeref] {
...
object Type extends TypeMeta {
  ...
  class Builder[+State] private[Type] (private var obj: RawType) {
    ...
    def simpleType(v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType): Type.Builder[State with Builder.HasSimpleType] = {
      obj.simpleType_=(v)
...
class TypeMeta
  ...
  val id =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Type, TypeMeta](
      ...
      owner = this,
      getter = _.idOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Type], v: String) => { r.asInstanceOf[RawType].id_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Type]) => { r.asInstanceOf[RawType].idUnset() },
      manifest = manifest[String]
    )

  val simpleType =
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.StructFieldDescriptor[Type, TypeMeta, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleTypeMeta](
      name = "simpleType",
      longName = "simpleType",
      id = 2,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Type], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType) => { r.asInstanceOf[RawType].simpleType_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Type]) => { r.asInstanceOf[RawType].simpleTypeUnset() },
...
trait Type
    extends JavaType[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType,
...
trait MutableType extends Type
    with JavaTypeMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType,
      Type, RawType, TypeMeta
    ] {
...
final class RawType extends JavaTypeRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType,
      Type, RawType, TypeMeta
    ]
    with MutableType {
  ...
  // Field #2 - simpleType
  private var _simpleType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType
  override def simpleType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType = simpleTypeOrThrow
  override def simpleType_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType): Unit = { _simpleType = x }
  override def simpleTypeOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType] = if (simpleTypeIsSet) Some(_simpleType) else None
  override def simpleTypeOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType = _simpleType
  override def simpleTypeOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType = if (simpleTypeIsSet) _simpleType else throw new java.lang.NullPointerException("field simpleType of Type missing")
  ...
  def setFieldValue(field: Type._Fields, value: AnyRef) {
    field match {
      ...
      case Type._Fields.simpleType => simpleType_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SimpleType])
      case _ =>
    }
  }
...
object Typedef extends TypedefMeta {
  ...
  class Builder[+State] private[Typedef] (private var obj: RawTypedef) {
    ...
    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Typedef.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): Typedef.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class TypedefMeta
  ...
  override val annotations: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.Annotations =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.Annotations(scala.collection.immutable.Vector(
      ("generate_proxy", "true")
    ))
  ...
  val typeId =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Typedef, TypedefMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Typedef], v: String) => { r.asInstanceOf[RawTypedef].typeId_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Typedef]) => { r.asInstanceOf[RawTypedef].typeIdUnset() },
      manifest = manifest[String]
    )
  ...
  val typeAlias =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Typedef, TypedefMeta](
      ...
      owner = this,
      getter = _.typeAliasOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Typedef], v: String) => { r.asInstanceOf[RawTypedef].typeAlias_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Typedef]) => { r.asInstanceOf[RawTypedef].typeAliasUnset() },
      manifest = manifest[String]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], Typedef, TypedefMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Typedef], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawTypedef].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Typedef]) => { r.asInstanceOf[RawTypedef].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Typedef, TypedefMeta]] =
...
class TypedefCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Typedef] {
...
trait Typedef
    extends JavaTypedef[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
...
trait MutableTypedef extends Typedef
    with JavaTypedefMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
      Typedef, RawTypedef, TypedefMeta
    ] {
...
// field/proxy_container.ssp
  override def __annotations: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = underlying.__annotations
  override def annotationsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]] = underlying.annotationsOption
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = underlying.annotationsOrDefault
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = underlying.annotationsOrNull
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = underlying.annotationsOrThrow
...
trait MutableTypedefProxy extends MutableTypedef with TypedefProxy {
  ...
  override def __annotations_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Unit = { underlying.__annotations_=(x) }
...
final class RawTypedef extends JavaTypedefRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
      Typedef, RawTypedef, TypedefMeta
    ]
    with MutableTypedef {
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of Typedef missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
  ...
  def setFieldValue(field: Typedef._Fields, value: AnyRef) {
    field match {
      ...
      case Typedef._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
object TypeRegistry extends TypeRegistryMeta {
  ...
  class Builder[+State] private[TypeRegistry] (private var obj: RawTypeRegistry) {
    def idToType(v: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type]): TypeRegistry.Builder[State with Builder.HasIdToType] = {
      obj.idToType_=(v)
...
class TypeRegistryMeta
  ...
  val idToType =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type], TypeRegistry, TypeRegistryMeta](
      name = "idToType",
      longName = "idToType",
      id = 1,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[TypeRegistry], v: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type]) => { r.asInstanceOf[RawTypeRegistry].idToType_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[TypeRegistry]) => { r.asInstanceOf[RawTypeRegistry].idToTypeUnset() },
      manifest = manifest[scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type]]
    )

  val aliasToTypeId =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.immutable.Map[String, String], TypeRegistry, TypeRegistryMeta](
      name = "aliasToTypeId",
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[TypeRegistry], v: scala.collection.immutable.Map[String, String]) => { r.asInstanceOf[RawTypeRegistry].aliasToTypeId_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[TypeRegistry]) => { r.asInstanceOf[RawTypeRegistry].aliasToTypeIdUnset() },
      manifest = manifest[scala.collection.immutable.Map[String, String]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, TypeRegistry, TypeRegistryMeta]] =
...
class TypeRegistryCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[TypeRegistry] {
...
trait TypeRegistry
    extends JavaTypeRegistry[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type,
  ...
  def copy(
      idToType: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type] = idToTypeOrNull,
...
trait MutableTypeRegistry extends TypeRegistry
    with JavaTypeRegistryMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type,
      TypeRegistry, RawTypeRegistry, TypeRegistryMeta
    ] {
  def idToType_=(x: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type]): Unit
...
final class RawTypeRegistry extends JavaTypeRegistryRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type,
      TypeRegistry, RawTypeRegistry, TypeRegistryMeta
    ]
  ...
  // fields
  // Field #1 - idToType
  private var _idToType: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type] = null  // Underlying type: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type]
  override def idToType: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type] = idToTypeOrDefault
  override def idToType_=(x: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type]): Unit = { _idToType = x }
  override def idToTypeOption: Option[scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type]] = if (idToTypeIsSet) Some(_idToType) else None
  override def idToTypeOrDefault: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type] = if (idToTypeIsSet) _idToType else scala.collection.immutable.Map.empty
  override def idToTypeOrNull: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type] = _idToType
  override def idToTypeOrThrow: scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type] = if (idToTypeIsSet) _idToType else throw new java.lang.NullPointerException("field idToType of TypeRegistry missing")
          ...
          case 1 => {  // idToType
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.MAP) {
              _idToType = {
                ...
                val builder = scala.collection.immutable.Map.newBuilder[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type]
  ...
  def setFieldValue(field: TypeRegistry._Fields, value: AnyRef) {
    field match {
      case TypeRegistry._Fields.idToType => idToType_=(value.asInstanceOf[scala.collection.immutable.Map[String, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Type]])
...
class ConstMeta
  ...
  val typeId =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Const, ConstMeta](
      ...
      owner = this,
      getter = _.typeIdOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Const], v: String) => { r.asInstanceOf[RawConst].typeId_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Const]) => { r.asInstanceOf[RawConst].typeIdUnset() },
      manifest = manifest[String]
    )
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Const, ConstMeta](
      ...
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Const], v: String) => { r.asInstanceOf[RawConst].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Const]) => { r.asInstanceOf[RawConst].nameUnset() },
      manifest = manifest[String]
    )
  ...
  val value =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Const, ConstMeta](
      ...
      owner = this,
      getter = _.valueOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Const], v: String) => { r.asInstanceOf[RawConst].value_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Const]) => { r.asInstanceOf[RawConst].valueUnset() },
      manifest = manifest[String]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Const, ConstMeta]] =
...
object EnumElement extends EnumElementMeta {
  ...
  class Builder[+State] private[EnumElement] (private var obj: RawEnumElement) {
    ...
    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): EnumElement.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): EnumElement.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class EnumElementMeta
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, EnumElement, EnumElementMeta](
      name = "name",
      longName = "name",
      id = 1,
      annotations = Map(),
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[EnumElement], v: String) => { r.asInstanceOf[RawEnumElement].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[EnumElement]) => { r.asInstanceOf[RawEnumElement].nameUnset() },
      manifest = manifest[String]
    )

  val value =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[Int, EnumElement, EnumElementMeta](
      name = "value",
      longName = "value",
      id = 2,
      annotations = Map(),
      owner = this,
      getter = _.valueOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[EnumElement], v: Int) => { r.asInstanceOf[RawEnumElement].value_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[EnumElement]) => { r.asInstanceOf[RawEnumElement].valueUnset() },
      manifest = manifest[Int]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], EnumElement, EnumElementMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[EnumElement], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawEnumElement].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[EnumElement]) => { r.asInstanceOf[RawEnumElement].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, EnumElement, EnumElementMeta]] =
...
class EnumElementCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[EnumElement] {
...
trait EnumElement
    extends JavaEnumElement[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
...
trait MutableEnumElement extends EnumElement
    with JavaEnumElementMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
      EnumElement, RawEnumElement, EnumElementMeta
    ] {
  def name_=(x: String): Unit
  def nameUnset(): Unit
...
final class RawEnumElement extends JavaEnumElementRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
      EnumElement, RawEnumElement, EnumElementMeta
    ]
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of EnumElement missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
  ...
  def setFieldValue(field: EnumElement._Fields, value: AnyRef) {
    field match {
      ...
      case EnumElement._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
object Enum extends EnumMeta {
  ...
  class Builder[+State] private[Enum] (private var obj: RawEnum) {
    ...
    def elements(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]): Enum.Builder[State with Builder.HasElements] = {
      obj.elements_=(v)
      this.asInstanceOf[Enum.Builder[State with Builder.HasElements]]
    }


    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Enum.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): Enum.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class EnumMeta
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Enum, EnumMeta](
      ...
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Enum], v: String) => { r.asInstanceOf[RawEnum].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Enum]) => { r.asInstanceOf[RawEnum].nameUnset() },
      manifest = manifest[String]
    )

  val elements =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement], Enum, EnumMeta](
      name = "elements",
      longName = "elements",
      id = 2,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Enum], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]) => { r.asInstanceOf[RawEnum].elements_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Enum]) => { r.asInstanceOf[RawEnum].elementsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], Enum, EnumMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Enum], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawEnum].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Enum]) => { r.asInstanceOf[RawEnum].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )
...
trait Enum
    extends JavaEnum[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement,
  ...
  def copy(
      name: String = nameOrNull,
      elements: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = elementsOrNull,
      __annotations: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = annotationsOrNull
  ): Enum
...
trait MutableEnum extends Enum
    with JavaEnumMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement,
      Enum, RawEnum, EnumMeta
    ] {
  def name_=(x: String): Unit
  def nameUnset(): Unit
...
// field/proxy_ref.ssp
  ...
  override def nameIsSet: Boolean = underlying.nameIsSet
// field/proxy_container.ssp
  override def elements: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = underlying.elements
  override def elementsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]] = underlying.elementsOption
  override def elementsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = underlying.elementsOrDefault
  override def elementsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = underlying.elementsOrNull
  override def elementsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = underlying.elementsOrThrow
...
trait MutableEnumProxy extends MutableEnum with EnumProxy {
  ...
  override def name_=(x: String): Unit = { underlying.name_=(x) }
  override def nameUnset(): Unit = { underlying.nameUnset() }
  override def elements_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]): Unit = { underlying.elements_=(x) }
...
final class RawEnum extends JavaEnumRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement,
      Enum, RawEnum, EnumMeta
    ]
    with MutableEnum {
  ...
  override def nameUnset(): Unit = { _name = null }
  // Field #2 - elements
  private var _elements: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]
  override def elements: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = elementsOrDefault
  override def elements_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]): Unit = { _elements = x }
  override def elementsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]] = if (elementsIsSet) Some(_elements) else None
  override def elementsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = if (elementsIsSet) _elements else scala.collection.Seq.empty
  override def elementsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = _elements
  override def elementsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement] = if (elementsIsSet) _elements else throw new java.lang.NullPointerException("field elements of Enum missing")
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of Enum missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
        ...
        field_header.id match {
          ...
          case 2 => {  // elements
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _elements = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
  ...
  def setFieldValue(field: Enum._Fields, value: AnyRef) {
    field match {
      ...
      case Enum._Fields.elements => elements_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.EnumElement]])
      case Enum._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
object Field extends FieldMeta {
  ...
  class Builder[+State] private[Field] (private var obj: RawField) {
    ...
    def requiredness(v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness): Field.Builder[State] = {
      obj.requiredness_=(v)
      this
    }

    def requiredness(vOpt: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness]): Field.Builder[State] = {
      vOpt match {
    ...
    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Field.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): Field.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class FieldMeta
  ...
  val identifier =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[Short, Field, FieldMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field], v: Short) => { r.asInstanceOf[RawField].identifier_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field]) => { r.asInstanceOf[RawField].identifierUnset() },
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Field, FieldMeta](
      ...
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field], v: String) => { r.asInstanceOf[RawField].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field]) => { r.asInstanceOf[RawField].nameUnset() },
      manifest = manifest[String]
    )
  ...
  val typeId =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Field, FieldMeta](
      ...
      owner = this,
      getter = _.typeIdOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field], v: String) => { r.asInstanceOf[RawField].typeId_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field]) => { r.asInstanceOf[RawField].typeIdUnset() },
      manifest = manifest[String]
    )

  val requiredness =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness, Field, FieldMeta](
      name = "requiredness",
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness) => { r.asInstanceOf[RawField].requiredness_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field]) => { r.asInstanceOf[RawField].requirednessUnset() },
  ...
  val defaultValue =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Field, FieldMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field], v: String) => { r.asInstanceOf[RawField].defaultValue_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field]) => { r.asInstanceOf[RawField].defaultValueUnset() },
      manifest = manifest[String]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], Field, FieldMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawField].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Field]) => { r.asInstanceOf[RawField].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Field, FieldMeta]] =
...
trait Field
    extends JavaField[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
...
trait MutableField extends Field
    with JavaFieldMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
      Field, RawField, FieldMeta
    ] {
...
// field/proxy_ref.ssp
  ...
  override def typeIdIsSet: Boolean = underlying.typeIdIsSet
// field/proxy_ref.ssp
  override def requirednessOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness] = underlying.requirednessOption
  override def requirednessOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness = underlying.requirednessOrNull
  override def requirednessOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness = underlying.requirednessOrThrow
...
trait MutableFieldProxy extends MutableField with FieldProxy {
  ...
  override def typeId_=(x: String): Unit = { underlying.typeId_=(x) }
  override def typeIdUnset(): Unit = { underlying.typeIdUnset() }
  override def requiredness_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness): Unit = { underlying.requiredness_=(x) }
...
final class RawField extends JavaFieldRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation,
      Field, RawField, FieldMeta
    ]
    with MutableField {
  ...
  private var _requiredness: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness
  override def requiredness_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness): Unit = { _requiredness = x }
  override def requirednessOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness] = if (requirednessIsSet) Some(_requiredness) else None
  override def requirednessOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness = _requiredness
  override def requirednessOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness = if (requirednessIsSet) _requiredness else throw new java.lang.NullPointerException("field requiredness of Field missing")
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of Field missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
      ...
      try {
        field_header.id match {
          ...
          case 4 => {  // requiredness
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.I32 || field_header.`type` == org.apache.thrift.protocol.TType.ENUM) {
              _requiredness = io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness.findByIdOrUnknown(iprot.readI32())
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field_header.`type`)
            }
          }
  ...
  def setFieldValue(field: Field._Fields, value: AnyRef) {
    field match {
      ...
      case Field._Fields.requiredness => requiredness_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Requiredness])
      case Field._Fields.defaultValue => defaultValue_=(value.asInstanceOf[String])
      case Field._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
object Struct extends StructMeta {
  ...
  class Builder[+State] private[Struct] (private var obj: RawStruct) {
    ...
    def __fields(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Struct.Builder[State with Builder.HasFields] = {
      obj.__fields_=(v)
      this.asInstanceOf[Struct.Builder[State with Builder.HasFields]]
    }


    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Struct.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): Struct.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class StructMeta
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Struct, StructMeta](
      ...
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Struct], v: String) => { r.asInstanceOf[RawStruct].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Struct]) => { r.asInstanceOf[RawStruct].nameUnset() },
      manifest = manifest[String]
    )

  val __fields =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field], Struct, StructMeta](
      name = "fields",
      longName = "fields",
      id = 2,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Struct], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]) => { r.asInstanceOf[RawStruct].__fields_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Struct]) => { r.asInstanceOf[RawStruct].fieldsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], Struct, StructMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Struct], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawStruct].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Struct]) => { r.asInstanceOf[RawStruct].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Struct, StructMeta]] =
...
class StructCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Struct] {
...
trait Struct
    extends JavaStruct[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
...
trait MutableStruct extends Struct
    with JavaStructMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
      Struct, RawStruct, StructMeta
    ] {
  def name_=(x: String): Unit
  def nameUnset(): Unit
...
// field/proxy_ref.ssp
  ...
  override def nameIsSet: Boolean = underlying.nameIsSet
// field/proxy_container.ssp
  override def __fields: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.__fields
  override def fieldsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]] = underlying.fieldsOption
  override def fieldsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.fieldsOrDefault
  override def fieldsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.fieldsOrNull
  override def fieldsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.fieldsOrThrow
...
trait MutableStructProxy extends MutableStruct with StructProxy {
  ...
  override def name_=(x: String): Unit = { underlying.name_=(x) }
  override def nameUnset(): Unit = { underlying.nameUnset() }
  override def __fields_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Unit = { underlying.__fields_=(x) }
...
final class RawStruct extends JavaStructRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
      Struct, RawStruct, StructMeta
    ]
    with MutableStruct {
  ...
  override def nameUnset(): Unit = { _name = null }
  // Field #2 - fields
  private var _fields: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]
  override def __fields: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = fieldsOrDefault
  override def __fields_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Unit = { _fields = x }
  override def fieldsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]] = if (fieldsIsSet) Some(_fields) else None
  override def fieldsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (fieldsIsSet) _fields else scala.collection.Seq.empty
  override def fieldsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = _fields
  override def fieldsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (fieldsIsSet) _fields else throw new java.lang.NullPointerException("field __fields of Struct missing")
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of Struct missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
        ...
        field_header.id match {
          ...
          case 2 => {  // fields
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _fields = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
  ...
  def setFieldValue(field: Struct._Fields, value: AnyRef) {
    field match {
      ...
      case Struct._Fields.__fields => __fields_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]])
      case Struct._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
object Union extends UnionMeta {
  ...
  class Builder[+State] private[Union] (private var obj: RawUnion) {
    ...
    def __fields(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Union.Builder[State with Builder.HasFields] = {
      obj.__fields_=(v)
      this.asInstanceOf[Union.Builder[State with Builder.HasFields]]
    }


    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Union.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): Union.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class UnionMeta
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Union, UnionMeta](
      ...
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Union], v: String) => { r.asInstanceOf[RawUnion].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Union]) => { r.asInstanceOf[RawUnion].nameUnset() },
      manifest = manifest[String]
    )

  val __fields =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field], Union, UnionMeta](
      name = "fields",
      longName = "fields",
      id = 2,
      annotations = Map(),
      owner = this,
      getter = _.fieldsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Union], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]) => { r.asInstanceOf[RawUnion].__fields_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Union]) => { r.asInstanceOf[RawUnion].fieldsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], Union, UnionMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Union], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawUnion].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Union]) => { r.asInstanceOf[RawUnion].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Union, UnionMeta]] =
...
trait Union
    extends JavaUnion[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
...
trait MutableUnion extends Union
    with JavaUnionMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
      Union, RawUnion, UnionMeta
    ] {
  def name_=(x: String): Unit
  def nameUnset(): Unit
...
final class RawUnion extends JavaUnionRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
      Union, RawUnion, UnionMeta
    ]
    with MutableUnion {
  ...
  override def fieldsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (fieldsIsSet) _fields else scala.collection.Seq.empty
  override def fieldsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = _fields
  override def fieldsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (fieldsIsSet) _fields else throw new java.lang.NullPointerException("field __fields of Union missing")
  override def fieldsIsSet: Boolean = _fields != null
  override def fieldsUnset(): Unit = { _fields = null }
  // Field #99 - annotations
  private var _annotations: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of Union missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
  ...
  def setFieldValue(field: Union._Fields, value: AnyRef) {
    field match {
      ...
      case Union._Fields.__fields => __fields_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]])
      case Union._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
object Exception extends ExceptionMeta {
  ...
  class Builder[+State] private[Exception] (private var obj: RawException) {
    ...
    def __fields(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Exception.Builder[State with Builder.HasFields] = {
      obj.__fields_=(v)
      this.asInstanceOf[Exception.Builder[State with Builder.HasFields]]
    }


    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Exception.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): Exception.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class ExceptionMeta
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Exception, ExceptionMeta](
      name = "name",
      longName = "name",
      id = 1,
      annotations = Map(),
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Exception], v: String) => { r.asInstanceOf[RawException].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Exception]) => { r.asInstanceOf[RawException].nameUnset() },
      manifest = manifest[String]
    )

  val __fields =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field], Exception, ExceptionMeta](
      name = "fields",
      longName = "fields",
      id = 2,
      annotations = Map(),
      owner = this,
      getter = _.fieldsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Exception], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]) => { r.asInstanceOf[RawException].__fields_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Exception]) => { r.asInstanceOf[RawException].fieldsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], Exception, ExceptionMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Exception], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawException].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Exception]) => { r.asInstanceOf[RawException].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Exception, ExceptionMeta]] =
...
class ExceptionCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Exception] {
...
trait Exception
    extends JavaException[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
...
trait MutableException extends Exception
    with JavaExceptionMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
      Exception, RawException, ExceptionMeta
    ] {
  def name_=(x: String): Unit
  def nameUnset(): Unit
...
final class RawException extends JavaExceptionRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
      Exception, RawException, ExceptionMeta
    ]
  ...
  override def fieldsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (fieldsIsSet) _fields else scala.collection.Seq.empty
  override def fieldsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = _fields
  override def fieldsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (fieldsIsSet) _fields else throw new java.lang.NullPointerException("field __fields of Exception missing")
  override def fieldsIsSet: Boolean = _fields != null
  override def fieldsUnset(): Unit = { _fields = null }
  // Field #99 - annotations
  private var _annotations: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of Exception missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
  ...
  def setFieldValue(field: Exception._Fields, value: AnyRef) {
    field match {
      ...
      case Exception._Fields.__fields => __fields_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]])
      case Exception._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
object Function extends FunctionMeta {
  ...
  class Builder[+State] private[Function] (private var obj: RawFunction) {
    ...
    def argz(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Function.Builder[State with Builder.HasArgz] = {
      obj.argz_=(v)
      this.asInstanceOf[Function.Builder[State with Builder.HasArgz]]
    }

    def throwz(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Function.Builder[State with Builder.HasThrowz] = {
      obj.throwz_=(v)
    ...
    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Function.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): Function.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class FunctionMeta
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Function, FunctionMeta](
      ...
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function], v: String) => { r.asInstanceOf[RawFunction].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function]) => { r.asInstanceOf[RawFunction].nameUnset() },
      manifest = manifest[String]
    )
  ...
  val returnTypeId =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Function, FunctionMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function], v: String) => { r.asInstanceOf[RawFunction].returnTypeId_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function]) => { r.asInstanceOf[RawFunction].returnTypeIdUnset() },
      manifest = manifest[String]
    )

  val oneWay =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[Boolean, Function, FunctionMeta](
      name = "oneWay",
      longName = "oneWay",
      id = 3,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function], v: Boolean) => { r.asInstanceOf[RawFunction].oneWay_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function]) => { r.asInstanceOf[RawFunction].oneWayUnset() },
      manifest = manifest[Boolean]
    )

  val argz =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field], Function, FunctionMeta](
      name = "argz",
      longName = "argz",
      id = 4,
      annotations = Map(),
      owner = this,
      getter = _.argzOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]) => { r.asInstanceOf[RawFunction].argz_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function]) => { r.asInstanceOf[RawFunction].argzUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]]
    )
  ...
  val throwz =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field], Function, FunctionMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]) => { r.asInstanceOf[RawFunction].throwz_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function]) => { r.asInstanceOf[RawFunction].throwzUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], Function, FunctionMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawFunction].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Function]) => { r.asInstanceOf[RawFunction].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Function, FunctionMeta]] =
...
class FunctionCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Function] {
...
trait Function
    extends JavaFunction[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
...
trait MutableFunction extends Function
    with JavaFunctionMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
      Function, RawFunction, FunctionMeta
    ] {
  def name_=(x: String): Unit
  def nameUnset(): Unit
...
// field/proxy_container.ssp
  override def argz: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.argz
  override def argzOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]] = underlying.argzOption
  override def argzOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.argzOrDefault
  override def argzOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.argzOrNull
  override def argzOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.argzOrThrow
  override def argzIsSet: Boolean = underlying.argzIsSet
// field/proxy_container.ssp
  override def throwz: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.throwz
  override def throwzOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]] = underlying.throwzOption
  override def throwzOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.throwzOrDefault
  override def throwzOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.throwzOrNull
  override def throwzOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = underlying.throwzOrThrow
...
trait MutableFunctionProxy extends MutableFunction with FunctionProxy {
  ...
  override def argz_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Unit = { underlying.argz_=(x) }
  override def argzUnset(): Unit = { underlying.argzUnset() }
  override def throwz_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Unit = { underlying.throwz_=(x) }
...
final class RawFunction extends JavaFunctionRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field,
      Function, RawFunction, FunctionMeta
    ]
  ...
  // Field #4 - argz
  private var _argz: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]
  override def argz: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = argzOrDefault
  override def argz_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Unit = { _argz = x }
  override def argzOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]] = if (argzIsSet) Some(_argz) else None
  override def argzOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (argzIsSet) _argz else scala.collection.Seq.empty
  override def argzOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = _argz
  override def argzOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (argzIsSet) _argz else throw new java.lang.NullPointerException("field argz of Function missing")
  override def argzIsSet: Boolean = _argz != null
  override def argzUnset(): Unit = { _argz = null }
  // Field #5 - throwz
  private var _throwz: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]
  override def throwz: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = throwzOrDefault
  override def throwz_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]): Unit = { _throwz = x }
  override def throwzOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]] = if (throwzIsSet) Some(_throwz) else None
  override def throwzOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (throwzIsSet) _throwz else scala.collection.Seq.empty
  override def throwzOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = _throwz
  override def throwzOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field] = if (throwzIsSet) _throwz else throw new java.lang.NullPointerException("field throwz of Function missing")
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of Function missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
  ...
  def setFieldValue(field: Function._Fields, value: AnyRef) {
    field match {
      ...
      case Function._Fields.argz => argz_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]])
      case Function._Fields.throwz => throwz_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Field]])
      case Function._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
object Service extends ServiceMeta {
  ...
  class Builder[+State] private[Service] (private var obj: RawService) {
    ...
    def functions(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]): Service.Builder[State with Builder.HasFunctions] = {
      obj.functions_=(v)
    ...
    def __annotations(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]): Service.Builder[State] = {
      obj.__annotations_=(v)
      this
    }

    def __annotations(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]): Service.Builder[State] = {
      vOpt match {
        case Some(v) => obj.__annotations_=(v)
        case None => obj.annotationsUnset()
      }
...
class ServiceMeta
  ...
  val name =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Service, ServiceMeta](
      ...
      owner = this,
      getter = _.nameOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Service], v: String) => { r.asInstanceOf[RawService].name_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Service]) => { r.asInstanceOf[RawService].nameUnset() },
      manifest = manifest[String]
    )
  ...
  val extendz =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[String, Service, ServiceMeta](
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Service], v: String) => { r.asInstanceOf[RawService].extendz_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Service]) => { r.asInstanceOf[RawService].extendzUnset() },
      manifest = manifest[String]
    )

  val functions =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function], Service, ServiceMeta](
      name = "functions",
      longName = "functions",
      id = 3,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Service], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]) => { r.asInstanceOf[RawService].functions_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Service]) => { r.asInstanceOf[RawService].functionsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]]
    )

  val __annotations =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation], Service, ServiceMeta](
      name = "annotations",
      longName = "annotations",
      id = 99,
      annotations = Map(),
      owner = this,
      getter = _.annotationsOption,
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Service], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]) => { r.asInstanceOf[RawService].__annotations_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Service]) => { r.asInstanceOf[RawService].annotationsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]]
    )

  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Service, ServiceMeta]] =
...
class ServiceCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Service] {
...
trait Service
    extends JavaService[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function,
  ...
  def copy(
      ...
      functions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = functionsOrNull,
      __annotations: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = annotationsOrNull
  ): Service
...
trait MutableService extends Service
    with JavaServiceMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function,
      Service, RawService, ServiceMeta
    ] {
  def name_=(x: String): Unit
  def nameUnset(): Unit
...
// field/proxy_container.ssp
  override def functions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = underlying.functions
  override def functionsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]] = underlying.functionsOption
  override def functionsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = underlying.functionsOrDefault
  override def functionsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = underlying.functionsOrNull
  override def functionsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = underlying.functionsOrThrow
...
trait MutableServiceProxy extends MutableService with ServiceProxy {
  ...
  override def functions_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]): Unit = { underlying.functions_=(x) }
...
final class RawService extends JavaServiceRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function,
      Service, RawService, ServiceMeta
    ]
    with MutableService {
  ...
  // Field #3 - functions
  private var _functions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]
  override def functions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = functionsOrDefault
  override def functions_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]): Unit = { _functions = x }
  override def functionsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]] = if (functionsIsSet) Some(_functions) else None
  override def functionsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = if (functionsIsSet) _functions else scala.collection.Seq.empty
  override def functionsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = _functions
  override def functionsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function] = if (functionsIsSet) _functions else throw new java.lang.NullPointerException("field functions of Service missing")
  ...
  override def annotationsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else scala.collection.Seq.empty
  override def annotationsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = _annotations
  override def annotationsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation] = if (annotationsIsSet) _annotations else throw new java.lang.NullPointerException("field __annotations of Service missing")
  override def annotationsIsSet: Boolean = _annotations != null
  override def annotationsUnset(): Unit = { _annotations = null }
  // end fields
        ...
        field_header.id match {
          ...
          case 3 => {  // functions
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _functions = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
  ...
  def setFieldValue(field: Service._Fields, value: AnyRef) {
    field match {
      ...
      case Service._Fields.functions => functions_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Function]])
      case Service._Fields.__annotations => __annotations_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Annotation]])
      case _ =>
    }
  }
...
object Program extends ProgramMeta {
  ...
  class Builder[+State] private[Program] (private var obj: RawProgram) {
    def typeRegistry(v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry): Program.Builder[State with Builder.HasTypeRegistry] = {
      obj.typeRegistry_=(v)
      this.asInstanceOf[Program.Builder[State with Builder.HasTypeRegistry]]
    }


    def namespaces(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]): Program.Builder[State] = {
      obj.namespaces_=(v)
      this
    }

    def namespaces(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]]): Program.Builder[State] = {
      vOpt match {
    ...
    def includes(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]): Program.Builder[State] = {
      obj.includes_=(v)
      this
    }

    def includes(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]]): Program.Builder[State] = {
      vOpt match {
    ...
    def constants(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]): Program.Builder[State] = {
      obj.constants_=(v)
      this
    }

    def constants(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]]): Program.Builder[State] = {
      vOpt match {
    ...
    def enums(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]): Program.Builder[State] = {
      obj.enums_=(v)
      this
    }

    def enums(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]]): Program.Builder[State] = {
      vOpt match {
    ...
    def typedefs(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]): Program.Builder[State] = {
      obj.typedefs_=(v)
      this
    }

    def typedefs(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]]): Program.Builder[State] = {
      vOpt match {
    ...
    def structs(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]): Program.Builder[State] = {
      obj.structs_=(v)
      this
    }

    def structs(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]]): Program.Builder[State] = {
      vOpt match {
    ...
    def unions(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]): Program.Builder[State] = {
      obj.unions_=(v)
      this
    }

    def unions(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]]): Program.Builder[State] = {
      vOpt match {
    ...
    def exceptions(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]): Program.Builder[State] = {
      obj.exceptions_=(v)
      this
    }

    def exceptions(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]]): Program.Builder[State] = {
      vOpt match {
    ...
    def services(v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]): Program.Builder[State] = {
      obj.services_=(v)
      this
    }

    def services(vOpt: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]]): Program.Builder[State] = {
      vOpt match {
...
class ProgramMeta
  ...
  val namespaces =
    ...
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace], Program, ProgramMeta](
      name = "namespaces",
      longName = "namespaces",
      id = 1,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]) => { r.asInstanceOf[RawProgram].namespaces_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].namespacesUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]]
    )

  val includes =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include], Program, ProgramMeta](
      name = "includes",
      longName = "includes",
      id = 2,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]) => { r.asInstanceOf[RawProgram].includes_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].includesUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]]
    )

  val constants =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const], Program, ProgramMeta](
      name = "constants",
      longName = "constants",
      id = 3,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]) => { r.asInstanceOf[RawProgram].constants_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].constantsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]]
    )

  val enums =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum], Program, ProgramMeta](
      name = "enums",
      longName = "enums",
      id = 4,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]) => { r.asInstanceOf[RawProgram].enums_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].enumsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]]
    )

  val typedefs =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef], Program, ProgramMeta](
      name = "typedefs",
      longName = "typedefs",
      id = 5,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]) => { r.asInstanceOf[RawProgram].typedefs_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].typedefsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]]
    )

  val structs =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct], Program, ProgramMeta](
      name = "structs",
      longName = "structs",
      id = 6,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]) => { r.asInstanceOf[RawProgram].structs_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].structsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]]
    )

  val unions =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union], Program, ProgramMeta](
      name = "unions",
      longName = "unions",
      id = 7,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]) => { r.asInstanceOf[RawProgram].unions_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].unionsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]]
    )

  val exceptions =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception], Program, ProgramMeta](
      name = "exceptions",
      longName = "exceptions",
      id = 8,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]) => { r.asInstanceOf[RawProgram].exceptions_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].exceptionsUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]]
    )

  val services =

    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.OptionalFieldDescriptor[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service], Program, ProgramMeta](
      name = "services",
      longName = "services",
      id = 9,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]) => { r.asInstanceOf[RawProgram].services_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].servicesUnset() },
      manifest = manifest[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]]
    )

  val typeRegistry =
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.StructFieldDescriptor[Program, ProgramMeta, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistryMeta](
      name = "typeRegistry",
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry) => { r.asInstanceOf[RawProgram].typeRegistry_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[Program]) => { r.asInstanceOf[RawProgram].typeRegistryUnset() },
  ...
  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, Program, ProgramMeta]] =
...
class ProgramCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[Program] {
...
trait Program
    extends JavaProgram[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union,
  ...
  def copy(
      namespaces: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = namespacesOrNull,
      ...
      exceptions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = exceptionsOrNull,
...
trait MutableProgram extends Program
    with JavaProgramMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union,
      Program, RawProgram, ProgramMeta
    ] {
...
// field/proxy_container.ssp
  override def namespaces: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = underlying.namespaces
  override def namespacesOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]] = underlying.namespacesOption
  override def namespacesOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = underlying.namespacesOrDefault
  override def namespacesOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = underlying.namespacesOrNull
  override def namespacesOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = underlying.namespacesOrThrow
  override def namespacesIsSet: Boolean = underlying.namespacesIsSet
// field/proxy_container.ssp
  override def includes: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include] = underlying.includes
  override def includesOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]] = underlying.includesOption
  override def includesOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include] = underlying.includesOrDefault
  override def includesOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include] = underlying.includesOrNull
  override def includesOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include] = underlying.includesOrThrow
  override def includesIsSet: Boolean = underlying.includesIsSet
// field/proxy_container.ssp
  override def constants: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const] = underlying.constants
  override def constantsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]] = underlying.constantsOption
  override def constantsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const] = underlying.constantsOrDefault
  override def constantsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const] = underlying.constantsOrNull
  override def constantsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const] = underlying.constantsOrThrow
  override def constantsIsSet: Boolean = underlying.constantsIsSet
// field/proxy_container.ssp
  override def enums: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum] = underlying.enums
  override def enumsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]] = underlying.enumsOption
  override def enumsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum] = underlying.enumsOrDefault
  override def enumsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum] = underlying.enumsOrNull
  override def enumsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum] = underlying.enumsOrThrow
  override def enumsIsSet: Boolean = underlying.enumsIsSet
// field/proxy_container.ssp
  override def typedefs: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef] = underlying.typedefs
  override def typedefsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]] = underlying.typedefsOption
  override def typedefsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef] = underlying.typedefsOrDefault
  override def typedefsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef] = underlying.typedefsOrNull
  override def typedefsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef] = underlying.typedefsOrThrow
  override def typedefsIsSet: Boolean = underlying.typedefsIsSet
// field/proxy_container.ssp
  override def structs: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct] = underlying.structs
  override def structsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]] = underlying.structsOption
  override def structsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct] = underlying.structsOrDefault
  override def structsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct] = underlying.structsOrNull
  override def structsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct] = underlying.structsOrThrow
  override def structsIsSet: Boolean = underlying.structsIsSet
// field/proxy_container.ssp
  override def unions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union] = underlying.unions
  override def unionsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]] = underlying.unionsOption
  override def unionsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union] = underlying.unionsOrDefault
  override def unionsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union] = underlying.unionsOrNull
  override def unionsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union] = underlying.unionsOrThrow
  override def unionsIsSet: Boolean = underlying.unionsIsSet
// field/proxy_container.ssp
  override def exceptions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = underlying.exceptions
  override def exceptionsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]] = underlying.exceptionsOption
  override def exceptionsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = underlying.exceptionsOrDefault
  override def exceptionsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = underlying.exceptionsOrNull
  override def exceptionsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = underlying.exceptionsOrThrow
  override def exceptionsIsSet: Boolean = underlying.exceptionsIsSet
// field/proxy_container.ssp
  override def services: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service] = underlying.services
  override def servicesOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]] = underlying.servicesOption
  override def servicesOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service] = underlying.servicesOrDefault
  override def servicesOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service] = underlying.servicesOrNull
  override def servicesOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service] = underlying.servicesOrThrow
  override def servicesIsSet: Boolean = underlying.servicesIsSet
// field/proxy_ref.ssp

  override def typeRegistry: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry = underlying.typeRegistry
  override def typeRegistryOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry] = underlying.typeRegistryOption
  override def typeRegistryOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry = underlying.typeRegistryOrNull
  override def typeRegistryOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry = underlying.typeRegistryOrThrow
...
trait MutableProgramProxy extends MutableProgram with ProgramProxy {
  ...
  override def namespaces_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]): Unit = { underlying.namespaces_=(x) }
  override def namespacesUnset(): Unit = { underlying.namespacesUnset() }
  override def includes_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]): Unit = { underlying.includes_=(x) }
  override def includesUnset(): Unit = { underlying.includesUnset() }
  override def constants_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]): Unit = { underlying.constants_=(x) }
  override def constantsUnset(): Unit = { underlying.constantsUnset() }
  override def enums_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]): Unit = { underlying.enums_=(x) }
  override def enumsUnset(): Unit = { underlying.enumsUnset() }
  override def typedefs_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]): Unit = { underlying.typedefs_=(x) }
  override def typedefsUnset(): Unit = { underlying.typedefsUnset() }
  override def structs_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]): Unit = { underlying.structs_=(x) }
  override def structsUnset(): Unit = { underlying.structsUnset() }
  override def unions_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]): Unit = { underlying.unions_=(x) }
  override def unionsUnset(): Unit = { underlying.unionsUnset() }
  override def exceptions_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]): Unit = { underlying.exceptions_=(x) }
  override def exceptionsUnset(): Unit = { underlying.exceptionsUnset() }
  override def services_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]): Unit = { underlying.services_=(x) }
  override def servicesUnset(): Unit = { underlying.servicesUnset() }
  override def typeRegistry_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry): Unit = { underlying.typeRegistry_=(x) }
...
final class RawProgram extends JavaProgramRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union,
      Program, RawProgram, ProgramMeta
    ]
    with MutableProgram {
  ...
  // fields
  // Field #1 - namespaces
  private var _namespaces: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]
  override def namespaces: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = namespacesOrDefault
  override def namespaces_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]): Unit = { _namespaces = x }
  override def namespacesOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]] = if (namespacesIsSet) Some(_namespaces) else None
  override def namespacesOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = if (namespacesIsSet) _namespaces else scala.collection.Seq.empty
  override def namespacesOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = _namespaces
  override def namespacesOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace] = if (namespacesIsSet) _namespaces else throw new java.lang.NullPointerException("field namespaces of Program missing")
  override def namespacesIsSet: Boolean = _namespaces != null
  override def namespacesUnset(): Unit = { _namespaces = null }
  // Field #2 - includes
  private var _includes: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]
  override def includes: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include] = includesOrDefault
  override def includes_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]): Unit = { _includes = x }
  override def includesOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]] = if (includesIsSet) Some(_includes) else None
  override def includesOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include] = if (includesIsSet) _includes else scala.collection.Seq.empty
  override def includesOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include] = _includes
  override def includesOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include] = if (includesIsSet) _includes else throw new java.lang.NullPointerException("field includes of Program missing")
  override def includesIsSet: Boolean = _includes != null
  override def includesUnset(): Unit = { _includes = null }
  // Field #3 - constants
  private var _constants: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]
  override def constants: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const] = constantsOrDefault
  override def constants_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]): Unit = { _constants = x }
  override def constantsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]] = if (constantsIsSet) Some(_constants) else None
  override def constantsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const] = if (constantsIsSet) _constants else scala.collection.Seq.empty
  override def constantsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const] = _constants
  override def constantsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const] = if (constantsIsSet) _constants else throw new java.lang.NullPointerException("field constants of Program missing")
  override def constantsIsSet: Boolean = _constants != null
  override def constantsUnset(): Unit = { _constants = null }
  // Field #4 - enums
  private var _enums: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]
  override def enums: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum] = enumsOrDefault
  override def enums_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]): Unit = { _enums = x }
  override def enumsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]] = if (enumsIsSet) Some(_enums) else None
  override def enumsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum] = if (enumsIsSet) _enums else scala.collection.Seq.empty
  override def enumsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum] = _enums
  override def enumsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum] = if (enumsIsSet) _enums else throw new java.lang.NullPointerException("field enums of Program missing")
  override def enumsIsSet: Boolean = _enums != null
  override def enumsUnset(): Unit = { _enums = null }
  // Field #5 - typedefs
  private var _typedefs: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]
  override def typedefs: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef] = typedefsOrDefault
  override def typedefs_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]): Unit = { _typedefs = x }
  override def typedefsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]] = if (typedefsIsSet) Some(_typedefs) else None
  override def typedefsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef] = if (typedefsIsSet) _typedefs else scala.collection.Seq.empty
  override def typedefsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef] = _typedefs
  override def typedefsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef] = if (typedefsIsSet) _typedefs else throw new java.lang.NullPointerException("field typedefs of Program missing")
  override def typedefsIsSet: Boolean = _typedefs != null
  override def typedefsUnset(): Unit = { _typedefs = null }
  // Field #6 - structs
  private var _structs: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]
  override def structs: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct] = structsOrDefault
  override def structs_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]): Unit = { _structs = x }
  override def structsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]] = if (structsIsSet) Some(_structs) else None
  override def structsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct] = if (structsIsSet) _structs else scala.collection.Seq.empty
  override def structsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct] = _structs
  override def structsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct] = if (structsIsSet) _structs else throw new java.lang.NullPointerException("field structs of Program missing")
  override def structsIsSet: Boolean = _structs != null
  override def structsUnset(): Unit = { _structs = null }
  // Field #7 - unions
  private var _unions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]
  override def unions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union] = unionsOrDefault
  override def unions_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]): Unit = { _unions = x }
  override def unionsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]] = if (unionsIsSet) Some(_unions) else None
  override def unionsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union] = if (unionsIsSet) _unions else scala.collection.Seq.empty
  override def unionsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union] = _unions
  override def unionsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union] = if (unionsIsSet) _unions else throw new java.lang.NullPointerException("field unions of Program missing")
  override def unionsIsSet: Boolean = _unions != null
  override def unionsUnset(): Unit = { _unions = null }
  // Field #8 - exceptions
  private var _exceptions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]
  override def exceptions: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = exceptionsOrDefault
  override def exceptions_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]): Unit = { _exceptions = x }
  override def exceptionsOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]] = if (exceptionsIsSet) Some(_exceptions) else None
  override def exceptionsOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = if (exceptionsIsSet) _exceptions else scala.collection.Seq.empty
  override def exceptionsOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = _exceptions
  override def exceptionsOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception] = if (exceptionsIsSet) _exceptions else throw new java.lang.NullPointerException("field exceptions of Program missing")
  override def exceptionsIsSet: Boolean = _exceptions != null
  override def exceptionsUnset(): Unit = { _exceptions = null }
  // Field #9 - services
  private var _services: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service] = null  // Underlying type: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]
  override def services: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service] = servicesOrDefault
  override def services_=(x: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]): Unit = { _services = x }
  override def servicesOption: Option[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]] = if (servicesIsSet) Some(_services) else None
  override def servicesOrDefault: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service] = if (servicesIsSet) _services else scala.collection.Seq.empty
  override def servicesOrNull: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service] = _services
  override def servicesOrThrow: scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service] = if (servicesIsSet) _services else throw new java.lang.NullPointerException("field services of Program missing")
  override def servicesIsSet: Boolean = _services != null
  override def servicesUnset(): Unit = { _services = null }
  // Field #98 - typeRegistry
  private var _typeRegistry: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry
  override def typeRegistry: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry = typeRegistryOrThrow
  override def typeRegistry_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry): Unit = { _typeRegistry = x }
  override def typeRegistryOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry] = if (typeRegistryIsSet) Some(_typeRegistry) else None
  override def typeRegistryOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry = _typeRegistry
  override def typeRegistryOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry = if (typeRegistryIsSet) _typeRegistry else throw new java.lang.NullPointerException("field typeRegistry of Program missing")
        ...
        field_header.id match {
          case 1 => {  // namespaces
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _namespaces = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
          ...
          case 2 => {  // includes
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _includes = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
          ...
          case 3 => {  // constants
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _constants = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
          ...
          case 4 => {  // enums
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _enums = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
          ...
          case 5 => {  // typedefs
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _typedefs = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
          ...
          case 6 => {  // structs
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _structs = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
          ...
          case 7 => {  // unions
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _unions = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
          ...
          case 8 => {  // exceptions
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _exceptions = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
          ...
          case 9 => {  // services
            ...
            if (field_header.`type` == org.apache.thrift.protocol.TType.LIST) {
              _services = {
                val tlist: org.apache.thrift.protocol.TList = iprot.readListBegin()
                val builder = scala.collection.immutable.Vector.newBuilder[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]
                var i: Int = tlist.size
                builder.sizeHint(tlist.size)
                while (i > 0) {
                  builder += ({
  ...
  def setFieldValue(field: Program._Fields, value: AnyRef) {
    field match {
      case Program._Fields.namespaces => namespaces_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Namespace]])
      case Program._Fields.includes => includes_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Include]])
      case Program._Fields.constants => constants_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Const]])
      case Program._Fields.enums => enums_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Enum]])
      case Program._Fields.typedefs => typedefs_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typedef]])
      case Program._Fields.structs => structs_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Struct]])
      case Program._Fields.unions => unions_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Union]])
      case Program._Fields.exceptions => exceptions_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Exception]])
      case Program._Fields.services => services_=(value.asInstanceOf[scala.collection.Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Service]])
      case Program._Fields.typeRegistry => typeRegistry_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TypeRegistry])
      case _ =>
    }
  }
...
object SimpleContainerType extends SimpleContainerTypeMeta {
  ...
  class Builder[+State] private[SimpleContainerType] (private var obj: RawSimpleContainerType) {
    ...
    def listType(v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType): SimpleContainerType.Builder[State] = {
      obj.listType_=(v)
      this
    }

    def listType(vOpt: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType]): SimpleContainerType.Builder[State] = {
      vOpt match {
    ...
    def setType(v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType): SimpleContainerType.Builder[State] = {
      obj.setType_=(v)
      this
    }

    def setType(vOpt: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType]): SimpleContainerType.Builder[State] = {
      vOpt match {
    ...
    def mapType(v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType): SimpleContainerType.Builder[State] = {
      obj.mapType_=(v)
      this
    }

    def mapType(vOpt: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType]): SimpleContainerType.Builder[State] = {
      vOpt match {
...
class SimpleContainerTypeMeta
  ...
  val listType =
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.StructFieldDescriptor[SimpleContainerType, SimpleContainerTypeMeta, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListTypeMeta](
      name = "listType",
      longName = "listType",
      id = 1,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleContainerType], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType) => { r.asInstanceOf[RawSimpleContainerType].listType_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleContainerType]) => { r.asInstanceOf[RawSimpleContainerType].listTypeUnset() },
  ...
  val setType =
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.StructFieldDescriptor[SimpleContainerType, SimpleContainerTypeMeta, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetTypeMeta](
      name = "setType",
      longName = "setType",
      id = 2,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleContainerType], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType) => { r.asInstanceOf[RawSimpleContainerType].setType_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleContainerType]) => { r.asInstanceOf[RawSimpleContainerType].setTypeUnset() },
  ...
  val mapType =
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.StructFieldDescriptor[SimpleContainerType, SimpleContainerTypeMeta, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapTypeMeta](
      name = "mapType",
      longName = "mapType",
      id = 3,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleContainerType], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType) => { r.asInstanceOf[RawSimpleContainerType].mapType_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleContainerType]) => { r.asInstanceOf[RawSimpleContainerType].mapTypeUnset() },
  ...
  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, SimpleContainerType, SimpleContainerTypeMeta]] =
    Vector[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, SimpleContainerType, SimpleContainerTypeMeta]](
      listType,
      setType,
      mapType
    )
...
class SimpleContainerTypeCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[SimpleContainerType] {
...
trait SimpleContainerType
    extends JavaSimpleContainerType[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType,
...
trait MutableSimpleContainerType extends SimpleContainerType
    with JavaSimpleContainerTypeMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType,
      SimpleContainerType, RawSimpleContainerType, SimpleContainerTypeMeta
    ] {
...
final class RawSimpleContainerType extends JavaSimpleContainerTypeRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType,
      SimpleContainerType, RawSimpleContainerType, SimpleContainerTypeMeta
    ]
  ...
  // fields
  // Field #1 - listType
  private var _listType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType
  override def listType_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType): Unit = { _listType = x }
  override def listTypeOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType] = if (listTypeIsSet) Some(_listType) else None
  override def listTypeOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType = _listType
  override def listTypeOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType = if (listTypeIsSet) _listType else throw new java.lang.NullPointerException("field listType of SimpleContainerType missing")
  override def listTypeIsSet: Boolean = _listType != null
  override def listTypeUnset(): Unit = { _listType = null }
  // Field #2 - setType
  private var _setType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType
  override def setType_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType): Unit = { _setType = x }
  override def setTypeOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType] = if (setTypeIsSet) Some(_setType) else None
  override def setTypeOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType = _setType
  override def setTypeOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType = if (setTypeIsSet) _setType else throw new java.lang.NullPointerException("field setType of SimpleContainerType missing")
  override def setTypeIsSet: Boolean = _setType != null
  override def setTypeUnset(): Unit = { _setType = null }
  // Field #3 - mapType
  private var _mapType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType
  override def mapType_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType): Unit = { _mapType = x }
  override def mapTypeOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType] = if (mapTypeIsSet) Some(_mapType) else None
  override def mapTypeOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType = _mapType
  override def mapTypeOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType = if (mapTypeIsSet) _mapType else throw new java.lang.NullPointerException("field mapType of SimpleContainerType missing")
  ...
  def setFieldValue(field: SimpleContainerType._Fields, value: AnyRef) {
    field match {
      case SimpleContainerType._Fields.listType => listType_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ListType])
      case SimpleContainerType._Fields.setType => setType_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.SetType])
      case SimpleContainerType._Fields.mapType => mapType_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.MapType])
      case _ =>
    }
  }
...
object SimpleType extends SimpleTypeMeta {
  ...
  class Builder[+State] private[SimpleType] (private var obj: RawSimpleType) {
    ...
    def baseType(vOpt: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType]): SimpleType.Builder[State] = {
      vOpt match {
    ...
    def containerType(v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType): SimpleType.Builder[State] = {
      obj.containerType_=(v)
      this
    }

    def containerType(vOpt: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType]): SimpleType.Builder[State] = {
      vOpt match {
    ...
    def typeref(vOpt: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref]): SimpleType.Builder[State] = {
      vOpt match {
...
class SimpleTypeMeta
  ...
  val baseType =
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.StructFieldDescriptor[SimpleType, SimpleTypeMeta, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseTypeMeta](
      name = "baseType",
      longName = "baseType",
      id = 1,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleType], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType) => { r.asInstanceOf[RawSimpleType].baseType_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleType]) => { r.asInstanceOf[RawSimpleType].baseTypeUnset() },
  ...
  val containerType =
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.StructFieldDescriptor[SimpleType, SimpleTypeMeta, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerTypeMeta](
      name = "containerType",
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleType], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType) => { r.asInstanceOf[RawSimpleType].containerType_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleType]) => { r.asInstanceOf[RawSimpleType].containerTypeUnset() },
  ...
  val typeref =
    new io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.StructFieldDescriptor[SimpleType, SimpleTypeMeta, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.TyperefMeta](
      name = "typeref",
      longName = "typeref",
      id = 3,
      annotations = Map(),
      ...
      setterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleType], v: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref) => { r.asInstanceOf[RawSimpleType].typeref_=(v) },
      unsetterRaw = (r: io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.MutableRecord[SimpleType]) => { r.asInstanceOf[RawSimpleType].typerefUnset() },
  ...
  override def untypedFields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.UntypedFieldDescriptor] = fields
  override val fields: Seq[io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.FieldDescriptor[_, SimpleType, SimpleTypeMeta]] =
...
class SimpleTypeCompanionProvider extends io.fsq.spindle.__shaded_for_spindle_bootstrap__.runtime.CompanionProvider[SimpleType] {
...
trait SimpleType
    extends JavaSimpleType[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref,
...
trait MutableSimpleType extends SimpleType
    with JavaSimpleTypeMutable[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref,
      SimpleType, RawSimpleType, SimpleTypeMeta
    ] {
...
final class RawSimpleType extends JavaSimpleTypeRaw[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType, io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref,
      SimpleType, RawSimpleType, SimpleTypeMeta
    ]
  ...
  // fields
  // Field #1 - baseType
  private var _baseType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType
  override def baseType_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType): Unit = { _baseType = x }
  override def baseTypeOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType] = if (baseTypeIsSet) Some(_baseType) else None
  override def baseTypeOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType = _baseType
  override def baseTypeOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType = if (baseTypeIsSet) _baseType else throw new java.lang.NullPointerException("field baseType of SimpleType missing")
  override def baseTypeIsSet: Boolean = _baseType != null
  override def baseTypeUnset(): Unit = { _baseType = null }
  // Field #2 - containerType
  private var _containerType: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType
  override def containerType_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType): Unit = { _containerType = x }
  override def containerTypeOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType] = if (containerTypeIsSet) Some(_containerType) else None
  override def containerTypeOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType = _containerType
  override def containerTypeOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType = if (containerTypeIsSet) _containerType else throw new java.lang.NullPointerException("field containerType of SimpleType missing")
  override def containerTypeIsSet: Boolean = _containerType != null
  override def containerTypeUnset(): Unit = { _containerType = null }
  // Field #3 - typeref
  private var _typeref: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref = null  // Underlying type: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref
  override def typeref_=(x: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref): Unit = { _typeref = x }
  override def typerefOption: Option[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref] = if (typerefIsSet) Some(_typeref) else None
  override def typerefOrNull: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref = _typeref
  override def typerefOrThrow: io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref = if (typerefIsSet) _typeref else throw new java.lang.NullPointerException("field typeref of SimpleType missing")
  ...
  def setFieldValue(field: SimpleType._Fields, value: AnyRef) {
    field match {
      case SimpleType._Fields.baseType => baseType_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.BaseType])
      case SimpleType._Fields.containerType => containerType_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.ContainerType])
      case SimpleType._Fields.typeref => typeref_=(value.asInstanceOf[io.fsq.spindle.__shaded_for_spindle_bootstrap__.descriptors.Typeref])
      case _ =>
    }
  }
